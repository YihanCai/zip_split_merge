...
class ZipSplitMergeApp:
    ...
    def create_merge_tab(self, parent):
        ...
        ttk.Entry(frame, textvariable=self.input_prefix_merge, width=40).grid(row=0, column=1, padx=5, columnspan=2)
...
if __name__ == "__main__":
    root = tk.Tk()
     # 加载PNG图片并转换为ICO
    img = Image.open(r"C:\Users\17728\Pictures\Saved Pictures\高木.png")  # 你的PNG图标
