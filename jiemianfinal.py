...
class ZipSplitMergeApp:
    ...
    def create_widgets(self):
        ...
        # 标题 - 修改为更大的字体和深蓝色
        title_label = ttk.Label(main_frame, text="ZIP 文件拆分与合并工具", 
                              font=('Arial', 16, 'bold'), foreground='#00008B')
    ...
    def create_merge_tab(self, parent):
        ...
        ttk.Entry(frame, textvariable=self.input_prefix_merge, width=40).grid(row=0, column=1, padx=5, columnspan=2, sticky=tk.W)
